...
MinimizeButton.AnchorPoint = Vector2.new(0.5, 0.5)
MinimizeButton.BackgroundTransparency = 1
MinimizeButton.Position = UDim2.new(0.6, 0, 0.5, 0)
...
ButtonContainer.Position = UDim2.new(0.1, 0, 0.25, 0)
...
UICorner_Submit.CornerRadius = UDim.new(0, 8)
...
UICorner_GetCode.CornerRadius = UDim.new(0, 8)
...
GetCodeStroke.Thickness = 1
GetCodeStroke.Transparency = 0.5

local NotificationFrame = Instance.new("Frame")
NotificationFrame.Parent = Content
NotificationFrame.BackgroundTransparency = 1
NotificationFrame.Size = UDim2.new(0.8, 0, 0, 25)
NotificationFrame.Position = UDim2.new(0.1, 0, 0.45, 0)
...
Circle2.Size = UDim2.new(0, 8, 0, 8)
...
task.wait(0.1)
TweenService:Create(Blur, TweenInfo.new(0.6, Enum.EasingStyle.Exponential), {Size = 10}):Play()
TweenService:Create(Frame, TweenInfo.new(0.6, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
    Size = UDim2.new(0, 350, 0, 200),
    BackgroundTransparency = 0.1
}):Play()
DropShadow.Visible = true
TweenService:Create(DropShadow, TweenInfo.new(0.6), {ImageTransparency = 0.4}):Play()
...
local isMinimized = false
local originalSize = UDim2.new(0, 350, 0, 200)
local minimizedSize = UDim2.new(0, 150, 0, 35)
